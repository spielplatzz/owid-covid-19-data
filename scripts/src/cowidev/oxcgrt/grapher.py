...
def run_grapheriser(input_path: str, input_path_country_std: str, output_path: str):
    ...
    rename_dict = {
        "Date": "Year",
        "C1M_School closing": "school_closures",
        "C2M_Workplace closing": "workplace_closures",
        "C3M_Cancel public events": "cancel_public_events",
        "C5M_Close public transport": "close_public_transport",
        "H1_Public information campaigns": "public_information_campaigns",
        "C7M_Restrictions on internal movement": "restrictions_internal_movements",
        ...
        "H6M_Facial Coverings": "facial_coverings",
        ...
        "V2_Pregnant people": "pregnant_vaccine_eligibility",
    }
